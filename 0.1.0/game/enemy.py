import random
from game.character import Enemy, enemies, easy_enemies, medium_enemies, hard_enemies, elite_enemies, mystic_enemies, spectral_enemies, bosses
...
class Random_Enemy:
    ...
    def get_enemy(self, stage):
        ...
        if stage % 10 == 0:
            ...
            enemy_tiers = [easy_enemies, medium_enemies, hard_enemies,
                           elite_enemies, mystic_enemies, spectral_enemies]
